// confirm-payment — phase 6/7. The contract is fixed by docs/06-payments.md and
...
Deno.serve(async (req) => {
  ...
  try { throw new HttpError(501, 'BG140', 'confirm-payment: payment provider credentials not configured (phase 6/7)'); }
