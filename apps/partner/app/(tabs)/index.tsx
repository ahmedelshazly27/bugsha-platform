...
export default function Today() {
  ...
  return <View style={{ flex: 1 }}>
    ...
    <Foot><View style={{ flexDirection: 'row', gap: 8 }}><Button variant="secondary" size="lg" iconStart="qr-code" style={{ flex: 1 }} onPress={() => router.push('/redeem')}>{L('Redeem', 'استلام')}</Button><Button size="lg" iconStart="plus" style={{ flex: 1 }} onPress={() => router.push('/listing/publish')}>{L('List a bag', 'أضف بقشة')}</Button></View></Foot></View>;
}
